...
export class HUD {
  ...
  constructor(private overlay: HTMLElement, private scoreManager: ScoreManager) {
    ...
    this.taskModalEl = this.mkDiv('position:absolute;inset:0;display:none;justify-content:center;align-items:center;background:radial-gradient(circle at 50% 42%,rgba(63,117,67,0.28),rgba(8,13,10,0.58));pointer-events:all;color:white;text-align:center;padding:20px;');
    this.screenEl = this.mkDiv('position:absolute;inset:0;display:none;justify-content:center;align-items:center;background:rgba(12,19,15,0.86);pointer-events:all;color:white;text-align:center;padding:24px;');
  }
